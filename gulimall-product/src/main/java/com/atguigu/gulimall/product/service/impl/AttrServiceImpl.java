...
//        2、保存关联关系
    ...
    public PageUtils queryBaseAttrPage(Map<String, Object> params, Long catelogId, String type) {
        ...
        List<AttrRespVo> respVos = records.stream().map((attrEnity) -> {
            AttrRespVo attrRespVo = new AttrRespVo();
            BeanUtils.copyProperties(attrEnity, attrRespVo);
//            设置分类和分组的名字
            AttrAttrgroupRelationEntity attrId = relationDao.selectOne(new QueryWrapper<AttrAttrgroupRelationEntity>().eq("attr_id", attrEnity.getAttrId()));
            ...
            CategoryEntity categoryEntity = categoryDao.selectById(attrEnity.getCatelogId());
